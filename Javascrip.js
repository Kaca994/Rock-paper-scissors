...
var choseaWinner = function(player, cpu){
...
var paragrph = document.querySelector('p');
...
var assignClick = function(tag, pos){
    tag.addEventListener('click', function(){
        ...
        paragrph.innerText = 'The computer chose: ' + cpuChoice.text;
        
        paragrph.innerText += '\n' + choseaWinner(playerChoice, cpuChoice.store);
        paragrph.innerText += '\n' + 'SCORE ' + score;
